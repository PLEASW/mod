class shipTree {
  ...
  get shiptrees() {
    ...
    Object.keys(this.initShiptree).forEach(key => this.#shiptrees[key] = [])
    for (let ship of ships) this.#shiptrees[ship.shiptree]?.push(ship);
    Object.values(this.#shiptrees).forEach(shiptrees => shiptrees.sort((a, b) => a.typespec.code - b.typespec.code))
    return this.#shiptrees;
  }
}